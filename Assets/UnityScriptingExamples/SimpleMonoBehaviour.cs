...
namespace UnityScriptingExamples
{
    ...
    [ExecuteAlways]
    [AddComponentMenu("UnityOOP/Simple MonoBehaviour")]
    public class SimpleMonoBehaviour : MonoBehaviour
    {
        ...
        {
            Debug.Log($"OnEnable is called. enabled = {enabled}. gameObject.activeSelf = {gameObject.activeSelf}");
        }

        private void OnDisable()
        {
            Debug.Log($"OnDisable is called. enabled = {enabled}. gameObject.activeSelf = {gameObject.activeSelf}");
        }
